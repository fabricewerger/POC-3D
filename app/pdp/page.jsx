...
export default function Page() {
  return (
    <>
      <About about={'Implement a 3D viewer next to normal images to evolve user experience.'} />

      <div className='mx-auto flex w-full flex-col flex-wrap items-center md:flex-row  lg:w-4/5'>
        <div className='flex w-full flex-col items-start justify-center p-12 text-center md:w-2/5 md:text-left'>
          <p className='w-full uppercase'>Youwe + React Three Fiber</p>
          <h1 className='my-4 text-5xl font-bold leading-tight'>PDP example</h1>
          <p className='mb-8 text-2xl leading-normal'>
            Intergrate React-three-fiber and Threejs into the PDP page and productcard.
          </p>
        </div>
      </div>
